...
const CACHE_NAME = 'app-factory-v5';
...
self.addEventListener('fetch', (event) => {
  ...
  event.respondWith(
    // ЗМІНЕНО: Додано об'єкт налаштувань { ignoreSearch: true } до методу match().
    // Це критично важливо для правильної роботи встановлених піддодатків.
    // Коли система робить запит на адресу виду "index.html?launchApp=tool_123", 
    // воркер ігноруватиме хвіст із параметрами і віддаватиме базовий кешований файл "index.html".
    // Після цього JS всередині сторінки сам прочитає параметр з адресного рядка та запустить потрібний код.
